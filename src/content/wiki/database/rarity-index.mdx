---
title: "RE:Heads, Please! Rarity Index | Wiki"
h1: "RE:Heads, Please! Rarity Index"
description: "Learn about rarity index in RE:Heads, Please!, including how it works, what players should verify, and which related wiki pages provide more detail."
keyword: "RE:Heads, Please! rarity index"
keywords:
  - "RE:Heads, Please! rarity index"
  - "RE Heads Please rarity index"
  - "rarity index in RE Heads Please"
slug: "rarity-index"
category: "database"
tags:
  - "database"
  ...
  - "informational"
cover: ""
coverAlt: "RE:Heads, Please! Rarity Index cover placeholder"
...
faq:
  - question: "What is the main purpose of this Rarity Index guide?"
  ...
  - question: "How should I verify information about Rarity Index?"
  ...
  - question: "Can Rarity Index information change?"
...
Rarity Index is a focused reference for players who want to make a clear decision without relying on copied lists or unsupported claims. A database entry is reliable only when labels, fields, and update notes distinguish confirmed information from details that still need checking. The practical question is not simply whether a name appears on a page. It is whether the information matches the current game, explains what the player can observe, and identifies what remains uncertain. This article therefore treats rarity labels and their limits as its main lens.
...
Start the review of Rarity Index by locating the current rarity index label or control. Record the state before the action, use one relevant input, and read the complete response. This sequence keeps the page tied to an observable result instead of a remembered or assumed rule.

Use RE:Heads, Please! rarity index to distinguish current evidence about Rarity Index from historical context. An older image may help identify a menu, but only the current prompt and resulting account state can support an immediate player decision.

The editorial purpose of this database page is structured lookup fields and their verification limits. That purpose determines which related link should be opened next and which facts should remain outside the scope of Rarity Index.

## FAQ
### What is the main purpose of this Rarity Index guide?
...
### How should I verify information about Rarity Index?
...
### Can Rarity Index information change?
