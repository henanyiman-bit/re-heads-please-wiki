---
title: "RE:Heads, Please! Complete Item List | Wiki"
h1: "RE:Heads, Please! Complete Item List"
description: "Learn about complete item list in RE:Heads, Please!, including how it works, what players should verify, and which related wiki pages provide more detail."
keyword: "RE:Heads, Please! complete item list"
keywords:
  - "RE:Heads, Please! complete item list"
  - "RE Heads Please complete item list"
  - "complete item list in RE Heads Please"
slug: "complete-item-list"
category: "items"
tags:
  - "items"
  - "wiki"
  ...
  - "informational"
cover: ""
coverAlt: "RE:Heads, Please! Complete Item List cover placeholder"
...
faq:
  - question: "What is the main purpose of this Complete Item List guide?"
  ...
  - question: "How should I verify information about Complete Item List?"
  ...
  - question: "Can Complete Item List information change?"
...
Complete Item List is a focused reference for players who want to make a clear decision without relying on copied lists or unsupported claims. An item is best understood through its current in-game label, description, source, and practical use rather than an unsupported value claim. The practical question is not simply whether a name appears on a page. It is whether the information matches the current game, explains what the player can observe, and identifies what remains uncertain. This article therefore treats coverage, navigation, and transparent gaps as its main lens.
...
Read Complete Item List with the limits of complete item list in mind. A dated Wiki observation provides review context, while the live game remains the immediate reference when labels, requirements, sources, or responses no longer match.

When reviewing Complete Item List, write down what RE:Heads, Please! complete item list looks like before and after the relevant action. If the outcome changes across devices, progression states, or updates, keep those conditions attached to the observation instead of declaring a universal rule.

The editorial purpose of this items page is item identification, acquisition, and inventory context. That purpose determines which related link should be opened next and which facts should remain outside the scope of Complete Item List.

## FAQ
### What is the main purpose of this Complete Item List guide?
...
### How should I verify information about Complete Item List?
...
### Can Complete Item List information change?
