---
title: "RE:Heads, Please! Controls Guide | Wiki"
h1: "RE:Heads, Please! Controls Guide"
description: "Learn about controls guide in RE:Heads, Please!, including how it works, what players should verify, and which related wiki pages provide more detail."
keyword: "RE:Heads, Please! controls guide"
keywords:
  - "RE:Heads, Please! controls guide"
  - "RE Heads Please controls guide"
  - "controls guide in RE Heads Please"
slug: "controls"
category: "guides"
tags:
  - "guides"
  ...
  - "informational"
cover: ""
coverAlt: "RE:Heads, Please! Controls Guide cover placeholder"
...
faq:
  - question: "What is the main purpose of this Controls Guide guide?"
  ...
  - question: "How should I verify information about Controls Guide?"
  ...
  - question: "Can Controls Guide information change?"
...
Separate discovery from evaluation on Controls Guide. First use controls to confirm that the correct record or system is open. Then decide whether the documented fields are sufficient for the player’s goal without importing claims from a neighboring page.

The RE:Heads, Please! controls guide portion of Controls Guide is best read as a verification checkpoint. Stop before spending a limited resource, compare the current interface with the page’s scope, and continue only when the expected action and result are clear.

The editorial purpose of this guides page is a reproducible player process with visible checkpoints. That purpose determines which related link should be opened next and which facts should remain outside the scope of Controls Guide.

## FAQ
### What is the main purpose of this Controls Guide guide?
...
### How should I verify information about Controls Guide?
...
### Can Controls Guide information change?
